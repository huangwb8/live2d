...
function loadWidget(config) {
	...
	(function registerEventListener() {
		...
		devtools.toString = () => {
			showMessage("哈哈，你打开了开发者工具，是想要看看我的小秘密吗？", 6000, 9);
		};
		...
		fetch(waifuPath)
			...
			.then(result => {
				...
				$("#live2d").mousedown(function(e) {
				        if(e.which==3){
				        showMessage("<div style=\"text-align:center\">秘密通道<br/><a href=\"javascript:aplayer_panel_toggle();\">音乐播放器</a><br/><a href=\"https://blognas.hwb0307.com/\" target=\"_blank\">WordPress</a><br/><a href=\"https://www.github.com/huangwb8/\" target=\"_blank\">Github</a><br/><a href=\"https://homenew.console.aliyun.com/\" target=\"_blank\">阿里云</a></div>",4000,10);
						}
				});
